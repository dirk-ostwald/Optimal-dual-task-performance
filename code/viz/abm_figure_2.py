...
plt     = abm_figure(plt)                                                       # configured pyplot module
...
lab    = sta.lab                                                                # Figure 2 panel labels
odir   = sta.f                                                                  # Figure 2 output directory
...
for j, p in enumerate(sta.p):                                                   # participant iterations
    ...
    ttl = ( r'\shortstack[c]{'                                                  # open centered title stack
            f'SUB-{str(p).zfill(3)} $|$ {c} $|$ First {n} trials'               # participant and condition line
            r'\\[7pt]'                                                          # vertical interline gap
            f'{ta} targets: {mem} $|$ {tb} decision: {dec[tb]}'                 # task-information line
            r'}')                                                               # close centered title stack
    ...
    ax.set_xlabel('Trial', fontsize = 12)                                       # x-axis label
    ttl = ( r'\shortstack[c]{'                                                  # open centered title stack
            f'SUB-{str(p).zfill(3)} $|$ {c} $|$ All trials'                     # participant and condition line
            r'\\[7pt]'                                                          # vertical interline gap
    ...
    # one Figure 2 panel per participant
